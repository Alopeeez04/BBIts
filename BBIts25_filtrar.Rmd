...
```{r}
# Beta-catenina
data_rec$beta_cateninap <- factor(data_rec$beta_cateninap,
                                  levels = c("0","1","2","NA"),
                                  labels = c("Negativo","Positivo","Otro","Desconocido"))

# MLH1
data_rec$mlh1 <- factor(data_rec$mlh1,
                        levels = c("0","2","NA"),
                        labels = c("Negativo","Positivo","Desconocido"))

# Tipo histológico (ejemplo: ajusta según tu diccionario real)
data_rec$tipo_histologico <- factor(data_rec$tipo_histologico,
                                    levels = c(1,2,3,4,5,7,8,9,10,12,88),
                                    labels = c("Endometrioide","Seroso","Mucinoso","Claro","Mixto",
                                               "Otro1","Otro2","Otro3","Otro4","Otro5","Desconocido"))
